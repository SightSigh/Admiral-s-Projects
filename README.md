...
项目名称|形式|数据更新状况|关注选定装备|统计消耗|记载进度|换日改修|
-------|----|----------|----------|-------|-------|-------|
星级争霸|POI预装插件|持续更新|可|每级纸面数据|有|不可|
明石工具箱（舰百）|手机应用|断更|可|每级纸面数据|无|不可|
AKASHI-LIST|网页|持续更新|可|按特定级别必成统计总消耗|无|不可|
（此表格）|EXCEL文件|持续更新|可|按实际结果统计总消耗|有|支持|
